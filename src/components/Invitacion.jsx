    ...
    <div className="w-full font-robotoSerif relative overflow-hidden bg-[#f8f5f0]">
        ...
        <section className="bg-white py-10 text-center px-6 md:px-20 relative">
          ...
          >
            ...
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed font-robotoSerif">
              ...
              <br />
              Hoy, después de 12 años de caminar de la mano, decidimos celebrar el amor que nos une y dar un nuevo paso: <span className="italic font-semibold text-[#69795d]">nos casamos.</span>
            </p>
            <img
              src={ringsInicio}
      ...
      <div>
        ...
        <div className="bg-[#69795d]">
          <div data-aos="fade-up">
            <LugaresLineal
              ...
              salon="Te esperamos en Salón La Palmera"
              hora_civil="13:00hs"
              hora_fiesta="21:00hs"
        ...
        <DatosBancarios
          ...
          nombre="Olga Carolina Centurión"
        ...
        <section className="bg-white py-12 text-center border-b-4 border-[#9eba8a] px-6 md:px-20 relative">
          ...
          >
            <p className="text-[#4b5147] text-lg md:text-3xl font-eleganteText italic mb-4">
              “Nunca te voy a dejar ir, porque la Biblia dice: ¡Encontré el amor de mi vida! lo abracé y no lo solté.”
            </p>
            <p className="text-[#69795d] font-semibold text-base italic md:text-xl mt-2">— Cantares 3:4</p>
          </div>
        </section>
